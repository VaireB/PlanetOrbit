...
public class SceneSetup : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameObject titan = Instantiate(moonPrefab, new Vector3(24, 0, 0), Quaternion.identity);
        titan.name = "Titan";
        GameObject rhea = Instantiate(moonPrefab, new Vector3(29, 0, 0), Quaternion.identity);
        rhea.name = "Rhea";
